  ...
  <head>
    ...
    <!-- Custom Scripts -->
	  ...
	  <script>
        ...
        content_css : '/projects/master/app/assets/css/style.css',  // resolved to http://domain.mine/myLayout.css
				force_br_newlines : true,
	      force_p_newlines : true,
	      forced_root_block : '',
				extended_valid_elements : 'a[href|role|class|onclick|target|rel|title]',
			 });
			 </script>
          ...
          <ul class="navbar-nav mr-auto">
            ...
            if (isset($_SESSION['userId'])) {
              ...
              <li class=\"nav-item dropdown\">
                ...
                <div class=\"dropdown-menu\" aria-labelledby=\"navDropDownUser\">
