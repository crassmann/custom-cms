...
<nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
  <div class="container">
    <a class="navbar-brand mb-0 h1" href="<? echo config::ROOT_APP_DIR; ?>"><span class="font-weight-bold text-light" itemprop="name">polarino</span></a>
    ...
    <div class="navbar-collapse offcanvas-collapse bg-dark" id="offcanvas">
      ...
      if (isset($_SESSION['userId'])) {
        echo "
            ...
            <li class='nav-item'>
              <a class='nav-link' href=\"".config::ROOT_APP_DIR."route/index/\"><i class='material-icons'>input</i> Routes</a>
            </li>
              <li class='nav-item'>
