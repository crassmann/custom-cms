  ...
  <form id="delete-item-form" action="<?php echo config::ROOT_APP_DIR."item/delete/"; ?>" method="post">
    <table class="table table-striped">
      ...
      <tbody>
        ...
        echo "<td><a href=\"".config::ROOT_APP_DIR."item/edit/".$item["id"]."\"><i class='material-icons md-12 md-light'>mode_edit</i></a></td>";
        echo "<td>".$item["id"]."</td>";
        echo "<td><a href=\"".config::ROOT_APP_DIR."item/show/".$item["id"]."\">".$item["name"]."</a></td>";
