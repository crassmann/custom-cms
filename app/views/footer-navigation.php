...
<footer class='container py-5'>
  <div class='row'>
    <div class='col-12 col-md mb-3' itemscope itemtype='http://schema.org/Organization'>
      <a class='h5 text-muted' itemprop='url' href='<?php echo $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].config::ROOT_APP_DIR; ?>'><?php echo htmlentities($args['property']['website_name']); ?></a>
      <small class='d-block mb-3 text-muted'>&copy; 2017-2018</small>
      <img itemprop='logo' src='<?php echo $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].config::ROOT_APP_DIR; ?>app/assets/img/<?php echo htmlentities($args['property']['brand_image']); ?>' alt='POLARINO' width='80' height='90'/><br />
    </div>
    <?php
