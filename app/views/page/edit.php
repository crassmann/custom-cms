...
<h1><?php echo ucfirst($args['controller']) . ' ' . ucfirst($args['action']) . ' ' . $args['url']['name'];?></h1>
  ...
  <form enctype="multipart/form-data" id="edit-navigation-form" action="<?php echo config::ROOT_APP_DIR."page/edit/".$args['request']; ?>" method="post">
    <table class="table table-striped">
      ...
      <tbody>
        ...
        echo "<td><button type=\"submit\" id=\"deleteItem\" name=\"deleteItem\" value=\"".$item["page_id"]."\" class=\"close\" aria-label=\"Close\"><i class=\"material-icons\">close</i></button></td>";
        echo "</tr><tr>";
        }
        ?>
        </tr>
    ...
    echo "<a class='mt-3 ml-2 btn btn-info' href='".config::ROOT_APP_DIR.$args['url']['url']."' role='button'>view</a>";
    ?>
  </form>
</div>
